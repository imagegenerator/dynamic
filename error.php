...
$codes=array(
      ...
      403 => array('403 Forbidden', 'Sorry, Forbidden!'),
      ...
      502 => array('502 Bad Gateway', 'The server received an invalid response from the upstream server while trying to fulfil the request.'),
